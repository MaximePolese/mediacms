        ...
        <LinksConsumer>
            {(links) => (
                <div className="empty-media empty-channel-media">
                    <div className="welcome-title">{translate_string('Welcome')} {props.name}</div>
                    <div className="start-uploading">
                        {translate_string('Start uploading media and sharing your work')} !
                    </div>
        ...
        this.setState(
            ...
            () => {
                if (this.state.query) {
                    ...
                    if (!count) {
                        title = translate_string('No results for') + ' "' + this.state.query + '"';
                    } else if (1 === count) {
                        title = '1 ' + translate_string('result for') + ' "' + this.state.query + '"';
                    } else {
                        title = count + ' ' + translate_string('results for') + ' "' + this.state.query + '"';
                    }
