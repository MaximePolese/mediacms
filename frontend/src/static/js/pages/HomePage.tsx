...
export const HomePage: React.FC<HomePageProps> = ({
  id = 'home',
  featured_title = translate_string(PageStore.get('config-options').pages.home.sections.featured.title),
  recommended_title = translate_string(PageStore.get('config-options').pages.home.sections.recommended.title),
  latest_title = translate_string(PageStore.get('config-options').pages.home.sections.latest.title),
