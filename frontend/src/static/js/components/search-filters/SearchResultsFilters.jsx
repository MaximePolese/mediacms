...
const filters = {
    media_type: [
        {id: 'all', title: translate_string('All')},
        {id: 'video', title: translate_string('Video')},
        {id: 'audio', title: 'Audio'},
        {id: 'image', title: translate_string('Image')},
        {id: 'pdf', title: 'Pdf'},
    ],
    upload_date: [
        {id: 'all', title: translate_string('All')},
        {id: 'today', title: translate_string('Today')},
        {id: 'this_week', title: translate_string('This week')},
        {id: 'this_month', title: translate_string('This month')},
        {id: 'this_year', title: translate_string('This year')},
    ],
    sort_by: [
        {id: 'date_added_desc', title: translate_string('Upload date newest')},
        {id: 'date_added_asc', title: translate_string('Upload date oldest')},
        {id: 'most_views', title: translate_string('View count')},
        ...
        <div ref={containerRef} className={'mi-filters-row' + (isHidden ? ' hidden' : '')}>
            <div ref={innerContainerRef} className="mi-filters-row-inner">
                <div className="mi-filter">
                    <div className="mi-filter-title">{translate_string('MEDIA TYPE')}</div>
                ...
                <div className="mi-filter">
                    <div className="mi-filter-title">{translate_string('UPLOAD DATE')}</div>
                    <div className="mi-filter-options">
                        <FilterOptions
                            id={'upload_date'}
                ...
                <div className="mi-filter">
                    <div className="mi-filter-title">{translate_string('SORT BY')}</div>
                    <div className="mi-filter-options">
                        <FilterOptions id={'sort_by'} options={filters.sort_by} selected={sortByFilter}
                                       onSelect={onFilterSelect}/>
                    </div>
                </div>
            </div>
