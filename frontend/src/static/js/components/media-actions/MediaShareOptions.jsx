...
export function MediaShareOptions(props) {
    ...
    return (
        ...
        >
            ...
            >
                <div className="share-popup-title">{translate_string('Share media')}</div>
                {shareOptions.length ? (
            ...
            {MediaPageStore.get('media-data').media_type === 'video' && (
                <div className="start-at">
                    <label>
                        ...
                        />
                        {translate_string('Start at')} {formattedTimestamp}
                    </label>
                </div>
            )}
        </div>
