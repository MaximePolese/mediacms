...
def stuff(request):
    ...
    ret[
        "POST_UPLOAD_AUTHOR_MESSAGE_UNLISTED_NO_COMMENTARY"] = settings.POST_UPLOAD_AUTHOR_MESSAGE_UNLISTED_NO_COMMENTARY
    ...
    ret["RSS_URL"] = "/rss"
    ret["FRONTEND_TRANSLATIONS"] = get_frontend_translations(settings.LANGUAGE_CODE)
    return ret
